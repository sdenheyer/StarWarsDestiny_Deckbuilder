...
fun CollectionList(
    ...
    LazyColumn(
        ...
        item {
            Text(
                buildAnnotatedString {
                    if (!characterExpanded) appendInlineContent("collapsedArrow", "collapsed") else appendInlineContent("dropDownArrow", "expanded")
                    append("Character")
                },
        ...
        item {
            Text(
                buildAnnotatedString {
                    if (!battlefieldExpanded) appendInlineContent("collapsedArrow", "collapsed") else appendInlineContent("dropDownArrow", "expanded")
                    append("Battlefield")
                },
                style = MaterialTheme.typography.headlineLarge,
                color = MaterialTheme.colorScheme.onPrimaryContainer,
        ...
        if (battlefieldExpanded)
            items(items = cards.filter { it.type == "Battlefield" }, key = { it.code }) { card ->
                CardItem(
                    isScreenCompact = isCompactScreen,
                    modifier = Modifier,
                    card = card,
        ...
        item {
            Text(
                buildAnnotatedString {
                    if (!plotExpanded) appendInlineContent("collapsedArrow", "collapsed") else appendInlineContent("dropDownArrow", "expanded")
                    append("Plot")
                },
                style = MaterialTheme.typography.headlineLarge,
                color = MaterialTheme.colorScheme.onPrimaryContainer,
        ...
        item {
            Text(
                buildAnnotatedString {
                    if (!upgradeExpanded) appendInlineContent("collapsedArrow", "collapsed") else appendInlineContent("dropDownArrow", "expanded")
                    append("Upgrade")
                },
                style = MaterialTheme.typography.headlineLarge,
                color = MaterialTheme.colorScheme.onPrimaryContainer,
        ...
        item {
            Text(
                buildAnnotatedString {
                    if (!downgradeExpanded) appendInlineContent("collapsedArrow", "collapsed") else appendInlineContent("dropDownArrow", "expanded")
                    append("Downgrade")
                },
                style = MaterialTheme.typography.headlineLarge,
                color = MaterialTheme.colorScheme.onPrimaryContainer,
        ...
        item {
            Text(
                buildAnnotatedString {
                    if (!supportExpanded) appendInlineContent("collapsedArrow", "collapsed") else appendInlineContent("dropDownArrow", "expanded")
                    append("Support")
                },
                style = MaterialTheme.typography.headlineLarge,
                color = MaterialTheme.colorScheme.onPrimaryContainer,
        ...
        item {
            Text(
                buildAnnotatedString {
                    if (!eventExpanded) appendInlineContent("collapsedArrow", "collapsed") else appendInlineContent("dropDownArrow", "expanded")
                    append("Event")
                },
                style = MaterialTheme.typography.headlineLarge,
                color = MaterialTheme.colorScheme.onPrimaryContainer,
